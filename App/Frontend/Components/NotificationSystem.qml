...
Item {
    ...
    property var defaultH: 80
    property var defaultW: 600
    property real marginTop: parent.height/50
    ...
    transitions: [
        Transition {
            ...
            SequentialAnimation {
                ...
                PropertyAnimation { property: "visible"; from: false; to: true; duration: 1 }
            }
        },
        Transition {
            from:"showT"
            to: "hideT"
            SequentialAnimation {
                AnchorAnimation { duration:400; easing.type: "InBack"  }
                PropertyAnimation { property: "visible"; from: true; to: false; duration: 1 }
            }
        },
        Transition {
            from:"hideB"
