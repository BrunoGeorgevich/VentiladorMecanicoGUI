...
from Backend.Controller.OperationController import OperationController
...
class System(QObject):
	...
	opc_has_changed = Signal(OperationController)
	@Property(OperationController, notify=opc_has_changed)
	def operation_controller(self, ): return self._operation_controller
